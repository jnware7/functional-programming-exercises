...
var ex4 = _.curry(function (n){ return Maybe.of(parseInt(n))})
...
var ex5 = undefined
//function(num){return getPost(num)}
// .then (_.compose(_.map(_toUpper, _.map(_.prop('title'))))}
...
var ex6 = user=>{return checkActive(user)}
...
var eithers = function(str){return str.length > 3 ? save(user) : ex7(user)}
var ex8 = function(eithers){return either(eithers)}
