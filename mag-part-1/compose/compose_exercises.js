...
// var _toLower = map(function(c) { return c._toLower(); })
...
var availablePrices = _.compose(join(', '),map(function(x){
    return accounting.formatMoney(x.dollar_value)}), available_cars)
...
// var fastestCar = function(cars) {
  ...
  var fastest = _.last();
  var string = function(fastest){return fastest.name + ' is the fastest';}
// };

var fastestCar = _.compose(string,fastest,sorted)
